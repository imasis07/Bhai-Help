      ...
      >
        <div className="relative rounded-3xl overflow-hidden" style={{ background: CARD, border: `1px solid ${BORDER}`, boxShadow: "0 32px 80px rgba(0,0,0,0.55), 0 0 0 1px rgba(255,255,255,0.03)" }}>
          ...
          <div className="px-8 pt-8 pb-9">
            ...
            <h1 className="text-[22px] font-bold text-white leading-tight mb-1">Welcome back</h1>
            <p className="text-sm mb-7" style={{ color: DIM }}>Sign in to your ROASTrack account.</p>
            ...
            <div className="flex items-center gap-3 mb-5">
              ...
              <span className="text-xs font-medium" style={{ color: DIM2 }}>or sign in with email</span>
              <div className="flex-1 h-px" style={{ background: "rgba(255,255,255,0.07)" }} />
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div>
                <div className="flex items-center justify-between mb-2">
                  <label className="text-xs font-semibold tracking-wide uppercase" style={{ color: DIM2 }}>Password</label>
                  <button type="button" className="text-xs font-medium transition-opacity hover:opacity-70" style={{ color: PRIMARY }}>
                    Forgot password?
                  </button>
                </div>
            ...
            <p className="text-center text-sm mt-6" style={{ color: DIM2 }}>
              ...
              <Link href="/sign-up" className="font-semibold" style={{ color: PRIMARY }}>Sign Up</Link>
            </p>
          </div>
        </div>
